...
class Jumpy3:
    ...
    def estimate_position(self, board):
        ...
        if self.is_white_win(board):
            ...
            score = white_king_index + black_king_index - 15
            score += white_king_index * .7
            score -= (15 - black_king_index) * .7
            return score
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 4:
        print("Usage: python MiniMax.py <input_file> <output_file> <depth>")
        sys.exit(1)
